 ...
 */
final class Version20230418175332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart_item ADD product_id INT DEFAULT NULL, ADD cart_id INT DEFAULT NULL, ADD uds INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart_item DROP product_id, DROP cart_id, DROP uds');
    }
}
